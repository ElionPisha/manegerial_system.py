...
def admin_session():
    while 1:
        ...
        if user_option == "1":
            ...
            command_handler.execute("INSERT INTO user (username, password, privilege) VALUES (%s,%s,'student')",query_vals)
            db.commit()
            print(username + " has been registered as a student")
                ...
                query_vals = (username, password)
                command_handler.execute("INSERT INTO user (username, password, privilege) VALUES (%s,%s,'teacher')", query_vals)
                db.commit()
...
def main():
    while 1:
        ...
        if user_option == "1":
            ...
            print("No valid opsion was selected")
